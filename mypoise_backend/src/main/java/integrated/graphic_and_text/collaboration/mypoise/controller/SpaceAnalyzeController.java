...
import integrated.graphic_and_text.collaboration.mypoise.services.SpaceAnalyzeService;
...
public class SpaceAnalyzeController {
     ...
     */
    @PostMapping("/tag")
    public BaseResponse<List<SpaceTagsAnalyzeResponse>> getSpaceTagAnalyze(
            @RequestBody SpaceTagAnalyzeRequest spaceTagAnalyzeRequest,
            HttpServletRequest request) {
        ThrowUtils.throwIf(spaceTagAnalyzeRequest == null, ErrorCode.PARAMS_ERROR);
        User loginUser = userService.getCurrentUser(request);
        List<SpaceTagsAnalyzeResponse> spaceTagAnalyze = spaceAnalyzeService.getSpaceTagAnalyze(spaceTagAnalyzeRequest, loginUser);
